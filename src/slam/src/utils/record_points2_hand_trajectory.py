...
if __name__ == "__main__":
    ...
    #electrodes
    #"""
    path_to_text_file = base_dir + "depth_variance/10/yolo_depth_3d_points.txt"
    path_to_save = base_dir + "electrode_position_from_text_file.npy"
    readElectrodesFromTextFile(path_to_text_file, path_to_save)
    
    
    electrode_array_path = base_dir + "electrode_position_from_text_file.npy"
    ...
    #temp = np.load(ground_truth_camera_pose_path, allow_pickle=True)
    #print(temp)
    """
