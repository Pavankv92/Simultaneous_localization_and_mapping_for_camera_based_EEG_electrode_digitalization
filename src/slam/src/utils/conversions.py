...
def ros2np_RTStampedWithHeader(ros_pose):
    #Rotation
    np_pose = tf.quaternion_matrix([ros_pose.transform.rotation.x, ros_pose.transform.rotation.y,
                                    ros_pose.transform.rotation.z, ros_pose.transform.rotation.w])
    # position
    np_pose[0][3] = ros_pose.transform.translation.x 
    np_pose[1][3] = ros_pose.transform.translation.y
    np_pose[2][3] = ros_pose.transform.translation.z
...
def ros2np_poseStamped(ros_pose):
...
def np2ros_poseStamped(np_pose):
    """Transform pose from np.array format to ROS poseStamped format.
    ...
    # ROS position
    ros_pose.pose.position.x = np_pose[0, 3]
    ros_pose.pose.position.y = np_pose[1, 3]
    ros_pose.pose.position.z = np_pose[2, 3]
